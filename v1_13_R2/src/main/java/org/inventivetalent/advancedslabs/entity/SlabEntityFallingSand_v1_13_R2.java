...
public class SlabEntityFallingSand_v1_13_R2 extends EntityFallingBlock implements ISlabFallingBlock {

	private boolean canDie = false;

	public SlabEntityFallingSand_v1_13_R2(World world) {
		super(world);
	}

	public SlabEntityFallingSand_v1_13_R2(World world, double d0, double d1, double d2, IBlockData iblockdata) {
