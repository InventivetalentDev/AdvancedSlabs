...
public class EntitySpawner_v1_9_R1 implements IEntitySpawner {
	...
	public ISlabFallingBlock spawnFallingBlock(Location location, Material material, String data) {
		SlabEntityFallingSand_v1_9_R1 entity = new SlabEntityFallingSand_v1_9_R1(((CraftWorld) location.getWorld()).getHandle(), location.getX(), location.getY(), location.getZ(), net.minecraft.server.v1_9_R1.Block.getById(material.getId()).getBlockData());
